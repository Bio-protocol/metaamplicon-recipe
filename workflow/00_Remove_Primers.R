...
# File parsing
path <- "./input" # CHANGE to the subdirectory containing your demultiplexed fastq files
filtpath <- "./cache/filtN" # CHANGE to the subdirectory where you want your cutadapted reads to live
...
path.cut <- file.path("cache/cutadapt")
