...
# This is only for fungal ITS amplicons...skip this script if working with bacteria
...
fwds <- list.files("./cache/cutadapt",pattern = "_pass_1",full.names = TRUE)
...
"itsxpress --fastq ./data/filtN/2554_pass_1.fastq.gz --outfile ./data/filtN/2554_ITS.fastq.gz.ITS1.gz --region ITS1 --taxa Fungi --threads 4 --log ./data/filtN/2554_ITS.fastq.gz.log --single-end"
